...
type User struct {
	...
	Provider   *string   `json:"provider,omitempty" gorm:"column:provider;type:varchar(50)"`
	ProviderID *string   `json:"provider_id,omitempty" gorm:"column:provider_id;type:varchar(255)"`
